...
card = df_card_info[df_card_info['1'] <= df_transaction['22'].min()]
print(card)
card = card.drop(['4','19','21','25','27','29','30','31'])
...
card_rank = df_card_info[['31', '1', '2','3']]
...
class CreditCardRecommendation:
    def __init__(self, card_data):
        ...
        self.benefit_matrix = np.array(self.card_data.drop(['0', '1', '2'], axis=1).values, dtype=np.float64).T
